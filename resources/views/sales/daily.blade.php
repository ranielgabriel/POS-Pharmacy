...
@section('content')
    <div class="col-md-12 responsive">
        <div class="form-group">
            ...
            <a role="button" class="btn btn-info" href="#" id="printDaily"><span class="fa fa-print">&nbsp;</span>Print</a>
        </div>
        {{-- {{ $sales->links() }} --}}
    </div>
@endsection
...
@section('formLogic')
    <script>
        $(document).ready(function (){
            ...
            $('#printDaily').click(function (){
                window.location.href = '/sales/daily/print/' + splitPathname[3];
            });
